/*
 ============================================================================
 Name        : ls-v1.6.0.c
 Description : Feature 7 – Recursive Listing (-R Option)
               Includes all previous features (1–6)
 ============================================================================
*/
...
// ---------- Recursive Listing ----------
void do_ls(const char *path, int flag_l, int flag_C, int flag_x, int flag_R) {
    char **names = NULL;
    ...
    if (flag_R) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (S_ISDIR(st.st_mode) &&
                strcmp(names[i], ".") != 0 &&
                strcmp(names[i], "..") != 0) {
                do_ls(full, flag_l, flag_C, flag_x, flag_R);
            }
        }
    }
...
int main(int argc, char *argv[]) {
    int flag_l = 0, flag_C = 0, flag_x = 0, flag_R = 0;
    int opt;
    ...
    do_ls(path, flag_l, flag_C, flag_x, flag_R);
    return 0;
}
